...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development, pick-up games, and interschool tournaments",
    ...
    # Artistic activities
    "Art Club": {
        "description": "Explore drawing, painting, sculpture and gallery visits",
    ...
    "Debate Team": {
        "description": "Practice formal debate, public speaking and attend competitions",
